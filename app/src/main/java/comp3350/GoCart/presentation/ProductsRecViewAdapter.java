...
public class ProductsRecViewAdapter extends RecyclerView.Adapter<ProductsRecViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.productCardName.setText(products.get(position).getProductName());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView productCardName;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            productCardName = itemView.findViewById(R.id.productCardName);
